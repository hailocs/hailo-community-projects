...
BABY_SLEEP_MONITOR_APP_TITLE = "Hailo Baby Sleep Monitor App"


# -----------------------------------------------------------------------------------------------
# User Gstreamer Application
# -----------------------------------------------------------------------------------------------
class GStreamerBabySleepMonitorApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        hailo_logger.info("Initializing GStreamer Baby Sleep Monitor App...")
        ...
        # Resolve HEF path using pose_estimation model resources
        ...
        setproctitle.setproctitle(BABY_SLEEP_MONITOR_APP_TITLE)
        hailo_logger.debug("Process title set: %s", BABY_SLEEP_MONITOR_APP_TITLE)
