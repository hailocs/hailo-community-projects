...
PARKING_LOT_APP_TITLE = "Hailo Parking Lot Occupancy App"

# COCO class labels for vehicles
VEHICLE_LABELS = {"car", "truck", "bus", "motorcycle"}

# -----------------------------------------------------------------------------------------------
# GStreamer Parking Lot Occupancy Application
# -----------------------------------------------------------------------------------------------


class GStreamerParkingLotApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        parser.add_argument(
            "--zones-json",
            default=None,
            help="Path to JSON file defining parking zones. "
                 "Format: [{\"name\": \"Zone A\", \"polygon\": [[x1,y1], [x2,y2], ...]}]. "
        ...
        hailo_logger.info("Initializing Parking Lot Occupancy App...")
        ...
        setproctitle.setproctitle(PARKING_LOT_APP_TITLE)
        hailo_logger.debug("Process title set to %s", PARKING_LOT_APP_TITLE)
    ...
    def get_pipeline_string(self):
        ...
        # Track all vehicle classes (class_id=-1 tracks all, we filter in callback)
...
def main():
    hailo_logger.info("Starting Parking Lot Occupancy App (pipeline only)...")
