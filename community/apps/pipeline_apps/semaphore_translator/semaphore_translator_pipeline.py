...
# App constants (not in defines.py to avoid modifying shared files)
SEMAPHORE_TRANSLATOR_APP_TITLE = "Hailo Semaphore Translator App"


# -----------------------------------------------------------------------------------------------
# User Gstreamer Application
# -----------------------------------------------------------------------------------------------
class GStreamerSemaphoreTranslatorApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        hailo_logger.info("Initializing GStreamer Semaphore Translator App...")
        ...
        # Reuses pose_estimation model config from resources_config.yaml
        ...
        setproctitle.setproctitle(SEMAPHORE_TRANSLATOR_APP_TITLE)
        hailo_logger.debug("Process title set: %s", SEMAPHORE_TRANSLATOR_APP_TITLE)
...
if __name__ == "__main__":
    hailo_logger.info("Launching Semaphore Translator App...")
    main()
