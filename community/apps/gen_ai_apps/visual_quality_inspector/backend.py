...
class Backend:
    ...
    def __init__(self, hef_path: str, max_tokens: int = 300, temperature: float = 0.1,
                 seed: int = 42, system_prompt: str = 'You are a quality inspection assistant.') -> None:
        """
        ...
        Args:
            ...
            system_prompt (str, optional): System prompt for VLM.
        """
